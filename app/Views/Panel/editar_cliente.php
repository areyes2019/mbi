	...
	<div class="my-card">
		...
		<form class="row g-3" action="<?php echo base_url('actualizar_cliente'); ?>" method="post">
			...
			<div class="col-md-6">
			    ...
			    <input type="text" class="my-input shadow-none form-control p-1" name="correo" value="<?php echo $cliente['correo'] ?>">
			</div>
			<div class="col-12">
			...
			<div class="col-md-5">
			    ...
			    <input type="text" class="my-input shadow-none form-control p-1"  name="ciudad" value="<?php echo $cliente['ciudad'] ?>">
			</div>
			<div class="col-md-4">
			    <label for="inputState" class="form-label">Estado</label>
			    <select id="inputState" class="form-select my-input shadow-none form-control p-1" name="estado" value=<?php echo $cliente['ciudad'] ?>>
			...
			<div class="col-md-1">
			    <label for="inputZip" class="form-label">Desc. %</label>
			    <input type="text" class="my-input shadow-none form-control p-1" id="inputZip" name="descuento" value="<?php echo $cliente['descuento'] ?>">
			</div>
			<div class="col-12">
